...
namespace WebApiAutores.Controllers
{
    ...
    public class AutoresController : ControllerBase
    {
        ...
        // OBTENIEDO EL VALOR DE UNA CONFIGURACION USANDO ICONFIGURATION
        [HttpGet("configuraciones")]
        public ActionResult<string> ObtenerConfiguracion()
        {
            //return configuration["apellido"]; //retorna el apellido: Silva
            //return configuration["ConnectionStrings:DefaultConnection"]; // retorna la cadena de conexionc
            return configuration["apellido"]; // retorna la variable de ambiente,. tambien se muesyta usando USER SECRETS
        }
